    ...
    drawTopBars: function() {
        var data = {
            topBar: {
                ...
                highlights: [0.09, 0.06, 0.06, 0.04],
        ...
        data.topBar.highlights = [0.09, 0.06, 0.06, 0.04];
    ...
    drawTopBars: function() {
        var data = {
            topBar: {
                ...
                // [0,1]=top 50% [2,3]=bottom 50%
                gradients:  ['#c8c8c8', '#b4b4b4', '#b3b3b3', '#9e9e9e'],

                // white alpha: [0]=top [1]=left [2]=right [3]=bottom
                highlights: ['0.12', '0.03', '0.03', '0.05'],
        ...
        data.topBar.highlights = [0.1, 0.06, 0.06, 0.05];
    ...
    outlineWindowFocused: function() {
        var data = {
            ...
            outline: {
                ...
                gradients: ['#999999', '#8a8a8a', '#808080'],
