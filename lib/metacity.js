...
var soxTheme = {
    ...
    buttons: {
        ...
        shade: {
            colors: [
                'shade/gtk:bg[SELECTED]/0.9', 'shade/gtk:bg[SELECTED]/1.2', 'shade/gtk:bg[SELECTED]/0.8', 
                'shade/#808080/1.4', 'shade/#808080/1.0', 'shade/#808080/0.8' 
            ],
...
var soxlTheme = merger.cloneextend(soxTheme, {
    buttons: {
        ...
        unshade: {
            ...
            images: ['images/gray-15/unshade-left-gloss.png', 'images/gray-15/unshade-left-gloss.png'],
            buttonStyle: BUTTON_STYLE_SINGLE_IMAGE
        }
...
function run() {
    ...
    renderTheme(soxBarTheme, __dirname + '/../../SO X. Bar', true, partials);
