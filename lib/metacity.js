...
var soxTheme = {
    buttons: {
        common: {
            ...
            // Offset images: 0=fg.x 1=fg.y 2=bg.x 3=bg.y
            offsets: [0, 0, 0, 0],
        },
        ...
        maximize: {
            ...
            bgImages: ['images/gray-15/close-x.png', 'images/gray-15/circle.png'],
        },

        restore: {
            images: ['images/gray-15/restore.png', 'images/gray-15/restore.png'],
            bgImages: ['images/gray-15/maximize.png', 'images/gray-15/circle.png'],
        },
...
var base = {
    ...
    buttons: {
        common: {
            ...
            // Offset images: 0=fg.x 1=fg.y 2=bg.x 3=bg.y
            offsets: [0, 0, 0, 1], // drop 1 pixel to give inset effect
        },
