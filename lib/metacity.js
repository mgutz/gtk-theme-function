...
var shinyTheme = {
    topbar_focused: {
        ...
        leftRightBorderAlpha: 0.08,
        gradient:  ['#cbcbcb', '#b7b7b7', '#b0b0b0', '#9c9c9c'],
    },

    topbar_unfocused: {
        topBorderAlpha: 0.13,
        bottomBorder: "shade/#b0b0b0/0.7",
        leftRightBorderAlpha: 0.08,
...
var base = {
    ...
    close_button: function() { 
        return function(draw_ops, render) {
            var data = {};
            Object.merge(data, this);
            data.widget_normal = '#000000';
            data.widget_prelight = "#a00";
            data.widget_pressed = "#600";

            data.widget_unfocused_normal = "#646464";
            data.widget_unfocused_prelight = "#a00";
            data.widget_unfocused_pressed = "#600";

            data.focused_hilite = "#bababa"
            data.unfocused_hilite = "#c0c0c0"
