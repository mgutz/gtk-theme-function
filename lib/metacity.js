...
var topBars = {
    shiny: {
        windowFocused: {
            ...
            // white alpha
            highlightArc: 'shade/#808080/1.36',
        },

        windowUnfocused: {
            gradients: ['#dfdfdf', '#cacaca', '#c5c5c5', '#b0b0b0'],
            highlights: [0.09, 0.04, 0.04, 0.04],
            highlightArc: 'shade/#808080/1.45',
        },
    },
    ...
    smooth: {
        ...
        windowUnfocused: {
            ...
            highlights: [0.1, 0.0, 0.0, 0.0],
            highlightArc:'shade/#808080/1.44',
        },
...
var draw = {
    point: function(color, x, y) {
       return '<line color="' +color+ '" width="0" x1="' +x+ '" y1="' +y+ '" x2="' +x+ '" y2="' +y+ '"/>';
    }
};
