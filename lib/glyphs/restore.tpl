...
<draw_ops name="restore_button_prelight">
    ...
    <image filename="images/black/restore-8.png" x="(width-8)/2 " y="(height-8)/2+1" width="8" height="8" alpha="0.7"/> 
</draw_ops>
...
<draw_ops name="restore_button_unfocused_normal">
    <image filename="images/circle-11-gray.png" x="(width-11)/2" y="(height-11)/2 +1" width="11" height="11" colorize="shade/gtk:bg[NORMAL]/0.83"/>
</draw_ops>
